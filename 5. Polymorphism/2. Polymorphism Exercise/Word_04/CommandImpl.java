...
import Word_04.textTransform.CutTransform;
import Word_04.textTransform.PasteTransform;
import Word_04.textTransform.TextTransform;
import Word_04.textTransform.ToUpperTransform;
...
public class CommandImpl implements CommandInterface {
    ...
    protected List<Command> initCommands() {
        ...
        // just like adding "uppercase" command, add the other two commands:
